			...
			<div class="d_grid col4">
				...
				<article class="footer_col">
					...
					<ul class='social_links'>
						...
						<li class='ytb'><a class='icon-play' href="<?php echo get_site_option( 'med_youtube_link' ); ?>">Youtube</a></li>
					</ul>
				</article>
				<article class="footer_col">
					<h4>Contact Us</h4>
					...
					<address>
						<a class='icon-earth'>
						Anandam, P O Box No:2,
						Petalad-388450 Gujarat
						India
						</a>
					</address>

					<ul>
						<li class='call'><a class='icon-call' href="tel:<?php echo get_site_option( 'med_call' ); ?>"><?php echo get_site_option( 'med_call' ); ?></a></li>
						<li class='fax'><a class='icon-fax' href="<?php echo get_site_option( 'med_fax' ); ?>"><?php echo get_site_option( 'med_fax' ); ?>
						</a></li>
						<li class='email'><a class='icon-email' href="mailto:<?php echo get_site_option( 'med_email' ); ?>"><?php echo get_site_option( 'med_email' ); ?></a></li>
					</ul>
				</article>
			</div>

			<p class="copyright"><?php echo get_site_option( 'med_copyright_text' ); ?></p>
